...
public class EnvironmentTrajectory
{
    public List<State> _states;
    public List<Reward> _rewards;
    public List<EnvironmentAction> _actions;
    ...
    public EnvironmentAction GetActionForStateNumber(int number)
    {
        return _actions[number];
    }

    public (EnvironmentAction, Reward, State) NextStep()
    {
    ...
    public EnvironmentTrajectory(State initialState)
    {
        _lastAdded = LastAdded.state;
        _states = new List<State>();
        _rewards = new List<Reward>();
        _actions = new List<EnvironmentAction>();
        _currentStateCounter = 0;
    ...
    public void AddAction(EnvironmentAction a)
    {
    ...
    public void AddStep(EnvironmentAction a, Reward r, State s)
    {
        AddAction(a);
        AddReward(r);
        AddState(s);
